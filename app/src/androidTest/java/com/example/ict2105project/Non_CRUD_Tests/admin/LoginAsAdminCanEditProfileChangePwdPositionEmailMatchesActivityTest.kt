...
class LoginAsAdminCanEditProfileChangePwdPositionEmailMatchesActivityTest {
    ...
    @Test
    fun loginAsAdminCanEditProfileChangePwdPositionEmailMatchesActivityTest() {
        ...
        textView.check(matches(withText("adamadmin@precursor.com")))
