...
class LoginStaffPossibleActivityTest {
    ...
    fun loginStaffPossibleActivityTest() {
        ...
        textInputEditText2.perform(replaceText("stevenstaff@precursor.com"), closeSoftKeyboard())
        ...
        textInputEditText4.perform(replaceText("stevenstaff"), closeSoftKeyboard())
