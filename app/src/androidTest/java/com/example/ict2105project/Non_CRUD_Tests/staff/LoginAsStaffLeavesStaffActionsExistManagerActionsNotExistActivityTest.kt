...
class LoginAsStaffLeavesStaffActionsExistManagerActionsNotExistActivityTest {
    ...
    @Test
    fun loginAsStaffLeavesStaffActionsExistManagerActionsNotExistActivityTest() {
        ...
        val buttonManagerApproveLeaveBtn = onView(
            allOf(
                withId(R.id.managerApproveLeaveButton),
                isDisplayed()
            )
        )
        buttonManagerApproveLeaveBtn.check(doesNotExist())
    }
