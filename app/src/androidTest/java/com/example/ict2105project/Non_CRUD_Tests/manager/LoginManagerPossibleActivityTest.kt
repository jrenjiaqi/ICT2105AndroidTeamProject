...
class LoginManagerPossibleActivityTest {
    ...
    @Test
    fun loginManagerPossibleActivityTest() {
        ...
        textInputEditText2.perform(replaceText("mikemanager@precursor.com"), closeSoftKeyboard())
        ...
        textInputEditText4.perform(replaceText("mikemanager"), closeSoftKeyboard())
